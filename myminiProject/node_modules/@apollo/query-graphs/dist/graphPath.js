...
class GraphPath {
    constructor(graph, root, tail, edgeTriggers, edgeIndexes, edgeConditions, subgraphEnteringEdgeIndex, subgraphEnteringEdge, subgraphEnteringEdgeCost, edgeToTail, runtimeTypesOfTail, runtimeTypesBeforeTailIfLastIsCast, deferOnTail) {
        this.graph = graph;
        this.root = root;
        this.tail = tail;
