...
const app = express()
const {ModelBook,BookSheft,ModelbookTask4,modelSchemaSongs,modelSchemaFinalTaskMongodb} = require('./bookSchema')
...
//facet
exports.facetplaylist = async (sortingName,groupData) => {
  try{
    // console.log(price)
